...
RESOURCE_DIR = os.getenv('RESOURCE_DIR', os.path.join(PROJECT_HOME, 'resources'))

DATA_DIR = os.getenv('DATA_DIR', os.path.join(PROJECT_HOME, 'data'))

LOG_DIR = os.getenv('LOG_DIR', os.path.join(PROJECT_HOME, 'log'))

MODEL_DIR = os.getenv('MODEL_DIR', os.path.join(PROJECT_HOME, 'models'))
